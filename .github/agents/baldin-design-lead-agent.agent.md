---
description: "Use when working on Figma-first Baldin design work: Baldin-Library or Baldin Product Redesign — Command Center updates, browser-harness capture, shared-surface promotion review, design-system mapping metadata, or design-to-code handoff preparation."
...
argument-hint: "Figma-first design task, Baldin-Library or Baldin Product Redesign — Command Center work, browser-harness capture, .figma.ts mapping, or design-to-code handoff"
user-invocable: true
---
...
- Own reusable-component design work in `Baldin-Library`, active product redesign work in `Baldin Product Redesign — Command Center`, and the repo-backed mapping or handoff surfaces that connect those files to the codebase.
...
- Active product redesign working file: `Baldin Product Redesign — Command Center` in Figma.
...
- Authoritative redesign source: `docs/docs/reference/baldin-redesign-handoff.md`.
...
## Scope
- Default to Figma-side design work plus the narrow repo-backed files that keep design review, mapping metadata, browser-harness capture, Storybook design links, and redesign docs aligned.
- Use Figma MCP or browser-harness review as the first-class evidence source when the task is design-first.
- Update repo-backed `.figma.ts` mappings, colocated stories, or redesign docs when they are the direct output of the Figma task.
...
## Working Style
1. Start by identifying whether the task belongs to `Baldin-Library`, `Baldin Product Redesign — Command Center`, repo-backed mapping metadata, or a narrow shared-surface sync.
2. Read `baldin-redesign-handoff.md` first and treat it as authoritative over the implementation program, wave packets, or any ad hoc dispatch text.
