...
Use [Baldin Project Conventions](../instructions/baldin-project.instructions.md), [Prompt The Right Agent](../../docs/docs/engineering/copilot-prompt-cookbook.md), [Contribute Safely](../../docs/docs/getting-started/contributing.md), [REPO_EXECUTION_PLAN](../../plans/REPO_EXECUTION_PLAN.md), [BACKLOG_AUDIT](../../plans/BACKLOG_AUDIT.md), the current issue templates under [ISSUE_TEMPLATE](../ISSUE_TEMPLATE), and [apply_backlog_audit.sh](../../scripts/apply_backlog_audit.sh).
