---
description: "Use when a Baldin task spans backend, frontend, contracts, docs, CI, scripts, docker-compose, or deployment boundaries and you need the smallest correct owner model with explicit handoffs."
