...
printf 'figma_canonical_files: operator-design/ active reference bundle; archived Figma files reference-only\n'
printf 'figma_make_surface: reviewed_archived_sandbox\n'
printf 'figma_policy_source: docs/docs/reference/operator-design-forward-path.md\n'
printf 'figma_workflow: Wave1 harness; operator-design forward path + plans/v2.1 packets; direct-route review + MCP/basic inspection; Code Connect publish optional\n'
