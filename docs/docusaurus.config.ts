    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          // Retired v2.1 and redesign docs now converge on the active operator-design contract.
          {from: '/engineering/design-system-catalog', to: '/docs/reference/operator-design-forward-path'},
          {from: '/engineering/design-system-governance', to: '/docs/reference/operator-design-forward-path'},
          {from: '/engineering/design-system-migration-guide', to: '/docs/reference/operator-design-forward-path'},
          {from: '/engineering/design-system-workflow', to: '/docs/reference/operator-design-forward-path'},
          {from: '/engineering/phase-2-design-system-closeout', to: '/docs/reference/operator-design-forward-path'},
          {from: '/engineering/redesign-implementation-program', to: '/docs/reference/operator-design-forward-path'},
          {from: '/engineering/v2-1-implementation-program', to: '/docs/reference/operator-design-forward-path'},
          ...
          {from: '/docs/engineering/design-system-catalog', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/design-system-governance', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/design-system-migration-guide', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/design-system-workflow', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/phase-2-design-system-closeout', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/redesign-implementation-program', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/v2-1-implementation-program', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/engineering/deployment-status', to: '/docs/engineering/release-roadmap'},
          {from: '/reference/baldin-redesign-handoff', to: '/docs/reference/operator-design-forward-path'},
          {from: '/reference/design-system-catalog', to: '/docs/reference/operator-design-forward-path'},
          {from: '/reference/v2-1-hard-fork', to: '/docs/reference/operator-design-forward-path'},
          ...
          {from: '/docs/reference/baldin-redesign-handoff', to: '/docs/reference/operator-design-forward-path'},
          {from: '/docs/reference/design-system-catalog', to: '/docs/reference/operator-design-forward-path'},
          ...
          {from: '/docs/reference/v2-1-hard-fork', to: '/docs/reference/operator-design-forward-path'},
        ],
      },
    ],
  ],
