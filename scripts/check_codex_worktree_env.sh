...
printf 'figma_policy_source: docs/docs/reference/baldin-app-screens-inventory.md\n'
printf 'figma_workflow: Wave1 harness; Wave2+ direct-route review + MCP/basic inspection; Code Connect publish optional\n'
